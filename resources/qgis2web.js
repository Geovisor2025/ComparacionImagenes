...
var map = new ol.Map({
    ...
    layers: layersList,
    view: new ol.View({
        center: ol.extent.getCenter([-7542305.984923, -1829876.546632, -7538811.400916, -1827976.473952]),
        zoom: 4, // menor número = menos zoom
        maxZoom: 50,
        minZoom: 0
    })
});
...
map.getView().fit([-7542305.984923, -1829876.546632, -7538811.400916, -1827976.473952], map.getSize());
...
document.getElementsByClassName('search-layer-input-search')[0].placeholder = 'Buscar Comunidad ...';
